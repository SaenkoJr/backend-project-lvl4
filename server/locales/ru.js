    ...
    flash: {
      ...
      users: {
        ...
        delete: {
          ...
          hasCreatedTasks: 'Не удалось удалить профиль. У вас остались созданные вами задачи',
          hasAssignedTasks: 'Не удалось удалить профиль. У вас остались незавершенные задачи',
        },
        access: {
